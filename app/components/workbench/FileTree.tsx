...
import { buildFileList, type FileNode, type FolderNode } from './file-tree-utils';
...
export { buildFileList } from './file-tree-utils';
export type { FileNode, FolderNode } from './file-tree-utils';
