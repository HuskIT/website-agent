/**
 * Sandbox Provider Interface and Types
...
export const SandboxStatusSchema = z.enum(['disconnected', 'connecting', 'connected', 'reconnecting', 'error']);
...
export const SandboxConfigSchema = z.object({
  ...
  timeout: z.number().default(10 * 60 * 1000), // 10 minutes default
...
export type SandboxProviderFactory = (type: SandboxProviderType, config: SandboxConfig) => SandboxProvider;
